...
Outputs:
- data/ph_occupations_v2_with_stats.json

Usage:
    python3 assign_ph_stats.py
"""
...
INPUT_JSON = DATA_DIR / "ph_occupations_v2.json"
OUTPUT_JSON = DATA_DIR / "ph_occupations_v2_with_stats.json"
