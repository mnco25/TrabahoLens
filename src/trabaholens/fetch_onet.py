...
OUTPUT_JSON = DERIVED_ONET_OCCUPATIONS_JSON
...
def main() -> None:
    ...
    print(f"Saved {occupation_data_path.name} and {job_zone_path.name} to {RAW_ONET_DIR}")
